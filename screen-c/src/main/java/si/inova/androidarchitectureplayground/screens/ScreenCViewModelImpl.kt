...
import si.inova.androidarchitectureplayground.di.SimpleStackActivityScope
import si.inova.androidarchitectureplayground.navigation.base.SingleScreenViewModel
import javax.inject.Inject
import kotlin.random.Random

@ContributesBinding(SimpleStackActivityScope::class, boundType = ScreenCViewModel::class)
